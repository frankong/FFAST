...
%% Set Parameters
D = 5;              % number of delays (increase to get noise robustness)
noise_flag = 1;     % set noisy flag, 0 = noiseless
SNRdB = 13;         % SNR, ignore if noise_flag = 0
...
thresh = rho*0.5;        % false detection threshold
...
figure,imshowf(abs(noisy_spectrum),[0,sqrt(rho)]),title('Noisy Spectrum','FontSize',14);
